...
「ターミナル」「シェル」「コンソール」「エディタ」……似たような言葉がたくさん出てきて混乱しますよね。この章では、これらの概念の違いを整理し、この書籍の dotfiles で何を使っているかを紹介します。
...
| ターミナルマルチプレクサ | **tmux**                                 | [tmux](./15-tmux)                                                       |
...
ただし、**複数のプロジェクトを行き来したい場合**や、**エディタとは独立したターミナルセッションが欲しい場合**は、専用のターミナルエミュレータを使う方が快適です。タブやペイン分割でプロジェクトを整理したり、ターミナルマルチプレクサ（tmux, Zellij）と組み合わせてセッションを維持したりできます。
...
この dotfiles では **tmux** をターミナルマルチプレクサとして使っています。TPM による豊富なプラグインエコシステムと、サーバー環境でもデフォルトで使えることが多い安定性が採用理由です。

詳しくは [tmux でターミナルマルチプレクサ入門](./15-tmux) チャプターで解説しています。
