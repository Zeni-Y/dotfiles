---
name: high-impact-journal-publishing
...
1. Clarify the research question and its clinical or scientific importance
2. Assess study design quality and statistical robustness
3. Guide manuscript structure and narrative coherence
4. Optimize title, abstract, and cover letter
5. Support journal selection and submission strategy
6. Advise on editorial decisions, peer review, revision, rejection, and acceptance steps
...
- `references/how-to-publish-high-impact.md`

Consult this file when detailed editor-facing rationale, reviewer expectations, or publication strategy justification is required.
...
- Use the core workflow for high-level advice.
- Load the reference file for detailed reasoning or when grounding answers in established editorial practice.
- Map recommendations explicitly to workflow stages.
- Favor practical, acceptance-oriented guidance.

## Constraints

- Do not invent journal policies or editorial rules.
- Do not duplicate large sections of the reference text unless explicitly requested.
- Keep responses focused on improving research quality and publication success.
